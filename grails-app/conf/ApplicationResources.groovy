modules = {
    angular {
		...
		//resource url:'js/app/slider.js'
		resource url:'components/revolution_slider/css/settings.css'
		resource url:'components/revolution_slider/css/style.css'
		resource url:'components/jquery.bxslider/jquery.bxslider.css'
		resource url:'components/flexslider/flexslider.css'
